...
This document provides guidelines for internationalization of the Sallmon Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `sallmon_en.ts` remains unchanged.
