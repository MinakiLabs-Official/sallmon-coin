Sallmon Core version *2.0.4.0* is now available!!
==============

  <https://github.com/SallmonProject/Sallmoncoin/releases/tag/v2.0.4>
...
Changelog available here: <https://github.com/SallmonProject/Sallmoncoin/commits/release_2.0.4>
