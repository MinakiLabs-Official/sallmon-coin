Sallmon Core version *2.1.0* is now available!!
==============

  <https://github.com/SallmonProject/Sallmoncoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/SallmonProject/Sallmoncoin/commits/release_2.1.0>
