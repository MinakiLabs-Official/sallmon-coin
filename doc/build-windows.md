...
Below are some notes on how to build Sallmon Core for Windows.
...
way. This will install to `c:\workspace\sallmon`, for example:

    make install DESTDIR=/mnt/c/workspace/sallmon
