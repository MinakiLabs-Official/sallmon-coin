## Sallmoncoin Metadata Specification

Additional fields may be added, but will be ignored by Sallmoncoin.
...
```
{
   ...
   "contract_signature": "<Sallmoncoin signed contract_hash>",
