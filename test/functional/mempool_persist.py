...
By default, sallmond will dump mempool on shutdown and
...
class MempoolPersistTest(SallmonTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give sallmond a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent sallmond from writing mempool.dat to disk. Verify that `savemempool` fails")
