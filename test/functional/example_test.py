...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the SallmonTestFramework
    pass

class ExampleTest(SallmonTestFramework):
    # Each functional test is a subclass of the SallmonTestFramework class.
    ...
    def custom_method(self):
        ...
        SallmonTestFramework class so other tests can use it."""
