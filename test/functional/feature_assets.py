...
class AssetTest(SallmonTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("SALLMON1", 1000)
        n0.issue("SALLMON2", 1000)
        n0.issue("SALLMON3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="SALLMON*", verbose=False, count=2, start=-2)
        ...
        sallmon_assets = n0.listassets(asset="SALLMON*", verbose=False, count=2, start=-2)
        assert_equal(len(sallmon_assets), 2)
        assert_equal(sallmon_assets[0], "SALLMON2")
        assert_equal(sallmon_assets[1], "SALLMON3")
        self.sync_all()
