...
class TestSallmonCli(SallmonTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `sallmon-cli getinfo`")
        ...
        self.log.info("Compare responses from `sallmon-cli -getinfo` and the RPCs data is retrieved from.")
