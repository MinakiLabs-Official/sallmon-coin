...
# TestNode: A peer we use to send messages to sallmond, and store responses.
...
class CompactBlocksTest(SallmonTestFramework):
    ...
    # This test actually causes sallmond to (reasonably!) disconnect us, so do this last.
    ...
    # Test that sallmond requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for sallmond to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # sallmond will not send blocktxn responses for blocks whose height is
