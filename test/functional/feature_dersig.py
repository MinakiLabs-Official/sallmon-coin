...
class BIP66Test(SallmonTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # sallmond is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and sallmond produces more specific reject
            # reasons.
