...
import os
import struct
from test_framework.test_framework import SallmonTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(SallmonTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that sallmon has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("sallmond has not been built with zmq enabled.")
