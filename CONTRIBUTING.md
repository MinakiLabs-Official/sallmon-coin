Contributing to Sallmon Core
============================

The Sallmon Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *GUI* for changes to sallmon-qt
  - *Mining* for changes to the mining code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST/ZMQ* for changes to the RPC, REST or ZMQ APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the sallmon unit tests or QA tests
...
The following applies to code changes to the Sallmoncoin project (and related
projects) and is not to be confused with overall Sallmoncoin
Network Protocol consensus changes.

Whether a pull request is merged into Sallmoncoin rests with the project merge
...
Patches that change Sallmoncoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Sallmoncoin consensus, it must have been
...
The SallmonQT-SIG selects a release manager for each Sallmoncoin release.
