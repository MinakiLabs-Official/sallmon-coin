...
We’re all in this together. There are new capabilities included in the latest Phoenix version (3.2+) of Sallmoncoin that open up new business opportunities.  Join in and build something.  This is not an exhaustive list, but just a starting point to fire the imagination.  
...
* Core
    * Asset Exchange Proxy (simulate sending an ASSET like sallmond does for RVN)
...
* Run a contest: RVN prize for best idea for new Sallmoncoin based Business
...
* Back-end API platform for Sallmoncoin
...
* #KYC tagger - store info and tag Sallmoncoin addresses
* #ACCREDITED - verify accredited status and tag Sallmoncoin addresses
 
### Technical Consultant
* Help companies apply Sallmoncoin capabilities to real-world problems
* Security Token Issuance Platform
...
### Areas for Sallmoncoin Innovation
* Financial
