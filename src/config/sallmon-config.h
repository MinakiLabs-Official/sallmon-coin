/* src/config/sallmon-config.h.  Generated from sallmon-config.h.in by configure.  */
/* src/config/sallmon-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef SALLMON_CONFIG_H

#define SALLMON_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Sallmon Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Sallmon Core"
...
#define PACKAGE_BUGREPORT "https://github.com/SallmonProject/Sallmoncoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Sallmon Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Sallmon Core 4.6.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "sallmon"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://sallmoncoin.org/"
