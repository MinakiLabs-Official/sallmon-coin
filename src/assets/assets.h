...
#ifndef SALLMONCOIN_ASSET_PROTOCOL_H
#define SALLMONCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_SALLMON_ASSET RVNQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_SALLMON_ASSET RVNO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_SALLMON_ASSET RVNR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_SALLMON_ASSET RVNT
...
#endif //SALLMONCOIN_ASSET_PROTOCOL_H
