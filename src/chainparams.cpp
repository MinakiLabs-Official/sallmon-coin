...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed1-sallmon.sallmoncoin.com", false);
        vSeeds.emplace_back("seed2-sallmon.sallmoncoin.com", false);
        vSeeds.emplace_back("seed3-sallmon.sallmoncoin.org", false);
        ...
        // Sallmon BIP44 cointype in mainnet is '175'
        nExtCoinType = 175;
        ...
        chainTxData = ChainTxData{
            // Update as we know more about the contents of the Sallmon chain
...
//        /////////////////////////////////////////////////////////////////
        ...
        vSeeds.emplace_back("seed-testnet-sallmon.bitactivate.com", false);
        vSeeds.emplace_back("seed-testnet-sallmon.sallmoncoin.com", false);
        vSeeds.emplace_back("seed-testnet-sallmon.sallmoncoin.org", false);
        ...
        // Sallmon BIP44 cointype in testnet
        nExtCoinType = 1;
...
//        /////////////////////////////////////////////////////////////////
        ...
        // Sallmon BIP44 cointype in regtest
        nExtCoinType = 1;
