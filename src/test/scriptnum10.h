...
#ifndef SALLMON_TEST_SCRIPTNUM10_H
#define SALLMON_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Sallmon Core 0.10.0, for cross-comparison.
 */
public:
