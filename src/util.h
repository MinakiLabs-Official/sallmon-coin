 ...
 */
#ifndef SALLMON_UTIL_H
#define SALLMON_UTIL_H
...
extern const char *const SALLMON_CONF_FILENAME;
extern const char *const SALLMON_PID_FILENAME;
...
{
    std::string s = strprintf("sallmon-%s", name);
