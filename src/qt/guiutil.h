...
#ifndef SALLMON_QT_GUIUTIL_H
#define SALLMON_QT_GUIUTIL_H
...
/** Utility functions used by the Sallmon Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "sallmon:" URI into recipient object, return true on successful parsing
