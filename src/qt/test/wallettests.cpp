...
#include "qt/sallmonamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<SallmonAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_sallmon-qt -platform xcb      # Linux
//     src/qt/test/test_sallmon-qt -platform windows  # Windows
//     src/qt/test/test_sallmon-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = SallmonUnits::formatWithUnit(unit, balance, false, SallmonUnits::separatorAlways);
    ...
    // Amount input
    SallmonAmountField* amountInput = receiveCoinsDialog.findChild<SallmonAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: sallmon:")) != -1);
