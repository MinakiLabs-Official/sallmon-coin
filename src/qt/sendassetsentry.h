...
#ifndef SALLMON_QT_SENDASSETSENTRY_H
#define SALLMON_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending sallmons.
...
#endif // SALLMON_QT_SENDASSETSENTRY_H
