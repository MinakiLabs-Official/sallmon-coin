...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(SallmonUnits::RVN),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(SallmonUnits::formatWithUnit(unit, balance, false, SallmonUnits::separatorAlways));
    ui->labelUnconfirmed->setText(SallmonUnits::formatWithUnit(unit, unconfirmedBalance, false, SallmonUnits::separatorAlways));
    ui->labelImmature->setText(SallmonUnits::formatWithUnit(unit, immatureBalance, false, SallmonUnits::separatorAlways));
    ui->labelTotal->setText(SallmonUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, SallmonUnits::separatorAlways));
    ui->labelWatchAvailable->setText(SallmonUnits::formatWithUnit(unit, watchOnlyBalance, false, SallmonUnits::separatorAlways));
    ui->labelWatchPending->setText(SallmonUnits::formatWithUnit(unit, watchUnconfBalance, false, SallmonUnits::separatorAlways));
    ui->labelWatchImmature->setText(SallmonUnits::formatWithUnit(unit, watchImmatureBalance, false, SallmonUnits::separatorAlways));
    ui->labelWatchTotal->setText(SallmonUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, SallmonUnits::separatorAlways));
