...
#ifndef SALLMON_QT_SALLMONGUI_H
#define SALLMON_QT_SALLMONGUI_H
...
/**
  Sallmon GUI main class. This class represents the main window of the Sallmon UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SallmonGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit SallmonGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~SallmonGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a sallmon wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
