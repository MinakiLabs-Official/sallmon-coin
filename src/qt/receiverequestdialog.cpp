...
#include "config/sallmon-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatSallmonURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + SallmonUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatSallmonURI(info));
}
