...
#ifndef SALLMON_QT_GUICONSTANTS_H
#define SALLMON_QT_GUICONSTANTS_H
...
/* SallmonGUI -- Size of icons in status bar */
...
/* Sallmoncoin label color as a string */
...
#define QAPP_ORG_NAME "Sallmon"
#define QAPP_ORG_DOMAIN "sallmon.org"
#define QAPP_APP_NAME_DEFAULT "Sallmon-Qt"
#define QAPP_APP_NAME_TESTNET "Sallmon-Qt-testnet"

/* Default third party browser urls */
#define DEFAULT_THIRD_PARTY_BROWSERS "https://api.sallmoncoin.org/tx/%s|https://rvn.cryptoscope.io/tx/?txid=%s|https://blockbook.sallmoncoin.org/tx/%s|https://explorer.mangofarmassets.com/tx/%s|https://www.assetsexplorer.com/tx/%s|https://explorer.sallmonland.org/tx/%s"

/* Default IPFS viewer */
#define DEFAULT_IPFS_VIEWER "https://ipfs.io/ipfs/%s"

#endif // SALLMON_QT_GUICONSTANTS_H
