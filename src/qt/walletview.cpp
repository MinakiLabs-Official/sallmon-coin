...
void WalletView::setSallmonGUI(SallmonGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? SallmonGUI::HD44_ENABLED : _walletModel->hdEnabled() ? SallmonGUI::HD_ENABLED : SallmonGUI::HD_DISABLED);
