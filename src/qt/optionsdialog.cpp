    ...
    mapper(0)
{
    ...
    ui->sallmonAtStartup->setToolTip(ui->sallmonAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->sallmonAtStartup->setText(ui->sallmonAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openSallmonConfButton->setToolTip(ui->openSallmonConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new SallmonUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->sallmonAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openSallmonConfButton_clicked()
{
