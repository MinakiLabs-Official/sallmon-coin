...
#ifndef SALLMON_QT_SALLMONUNITS_H
#define SALLMON_QT_SALLMONUNITS_H
...
/** Sallmon unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SallmonUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SallmonUnits(QObject *parent);
...
typedef SallmonUnits::Unit SallmonUnit;

#endif // SALLMON_QT_SALLMONUNITS_H
