...
#ifndef SALLMON_QT_OPTIONSMODEL_H
#define SALLMON_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Sallmon client.
...
#endif // SALLMON_QT_OPTIONSMODEL_H
